...
func InitializedShortedLinkService(db *gorm.DB, validate *validator.Validate, redisService redis.RedisService,
	...
	return New(db, validate, redisService, shortedLinkRepository, generatorService, maxMonthlyUserInt)
}
